...
import de.jakob_kroemer.domain.Customer;
import de.jakob_kroemer.domain.LoanQuote;
import de.jakob_kroemer.domain.LoanRequest;
import de.jakob_kroemer.gateway.LoanBrokerGateway;

/**
 * @author Gary Russell
 */
public class LoanBrokerSharkDetector {

	private static final Log logger = LogFactory.getLog(LoanBrokerSharkDetector.class);
